...
class AutomationEngine:
    ...
    def _get_sorted_automation_names(self):
        ...
        import json, glob, os
        data_dir = os.path.join(get_user_data_path(), 'automations')
    ...
    def execute_workflow(self, workflow_name=None, _visited=None, _depth=0):
        ...
        legacy_path = os.path.join(get_user_data_path(), "workflow.json")
                    ...
                    if val:
                        ...
                        if val.startswith("automations://"):
                            ...
                            sub_file = os.path.join(
                                get_user_data_path(), 'automations', f"{sub_name}.json"
                            )
